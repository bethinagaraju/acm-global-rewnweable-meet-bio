...
const ScientificSession: React.FC = () => {
  const sessions = [
    ...
    "Biosignal Analysis and Medical Decision Support",
    "Healthcare Cybersecurity and Data Privacy",
    "AI-driven Radiology and Pathology",
    "Assistive Technologies for Disability Care",
  ...
  return (
    <div className="w-full py-14 px-4 bg-[#FFFFFF]">

      {/* Heading */}
      <h1 className="text-center text-3xl md:text-4xl font-bold mb-10 text-[#2F3E3B]">
        ICBME 2026 Conference Topics
      </h1>
