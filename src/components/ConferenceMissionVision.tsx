...
const ConferenceMissionVision: React.FC = () => {
  ...
  //     title: "Vision",
  //     icon: Globe,
  //     desc: "Our vision is to build a globally connected, inclusive AI and robotics community. One where knowledge is shared openly, technology remains human-centric, and advancements contribute to safety, sustainability, and equitable technological growth across borders and generations.",
