...
//         {/* Heading */}
//         <div className="flex items-center mb-8">
//           <Target className="w-8 h-8 text-[#3B6F6A] mr-3" />
//           <h2 className="text-3xl font-bold text-[#2F3E3B]">
//             Mission, Vision & Values
//           </h2>
//         </div>
...
//         <div>
//           <div className="flex items-center mb-4">
//             <Star className="w-6 h-6 text-[#3B6F6A] mr-2" />
  ...
  const items = [
    {
      ...
      icon: Target,
      desc:
        "To accelerate translational innovation by bridging engineering research and clinical practice, enabling faster adoption of novel diagnostics, therapeutics, and biomedical devices.",
    },
    {
      title: "Vision",
      icon: Globe,
      desc:
        "To become a globally trusted forum fostering collaboration among academia, healthcare providers, industry innovators, and regulatory stakeholders to advance responsible healthcare innovation.",
    },
  ];

  const values = [
    "Fostering collaboration across academia, healthcare, industry, and regulators",
    "Sharing cutting-edge research in biomechatronics, medical imaging, neural engineering, and AI-augmented healthcare",
    "Accelerating translational research from lab to clinical practice",
    "Promoting responsible, ethical, and patient-centric innovation in medicine",
  ];
