  ...
  day1: [
    {
      ...
      title: "Registration & Welcome Coffee",
      description:
        "Check-in, collect your conference materials, and connect with fellow researchers, clinicians, and industry professionals.",
      speaker: null,
      room: "Lobby",
    },
    {
      time: "09:00 - 10:00",
      title: "Keynote: Advancing Healthcare Through Biomedical Innovation",
      description:
        "A keynote address exploring how biomedical engineering, medical technologies, and translational research are transforming modern healthcare.",
      speaker: null,
      room: "Main Hall",
    },
    {
      time: "10:00 - 11:30",
      title:
        "Panel Discussion: The Future of Biomedical Engineering in Clinical Practice",
      description:
        "Experts discuss the role of biomedical engineering in diagnostics, therapeutics, clinical workflows, and patient-centered healthcare solutions.",
      speaker: null,
      room: "Conference Room 1",
    },
    {
      ...
      title: "Coffee & Networking Break",
      description:
        "Engage in meaningful discussions and networking with researchers, clinicians, and industry leaders in biomedical engineering.",
      speaker: null,
      room: "Lobby",
    },
    {
      time: "12:00 - 13:30",
      title:
        "Track 1: Medical Devices, Diagnostics & Biomedical Instrumentation",
      description:
        "Sessions focused on the design, development, and clinical application of medical devices, diagnostic systems, and biomedical instrumentation.",
      speaker: null,
      room: "Workshop Room A",
    },
    {
      ...
      title: "Networking Lunch",
      description:
        "A dedicated lunch session to foster collaborations across academia, healthcare, and industry.",
      speaker: null,
      room: "Dining Hall",
    },
    {
      time: "14:30 - 16:00",
      title:
        "Track 2: Biomaterials, Tissue Engineering & Regenerative Medicine",
      description:
        "In-depth discussions on biomaterials, tissue engineering strategies, regenerative therapies, and their clinical translation.",
      speaker: null,
      room: "Workshop Room B",
    },
  ],
...
const Agenda: React.FC = () => {
      ...
      >
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <div className="sm:w-3/4">
            <h3 className="text-base font-bold text-[#2F3E3B]">
              {item.title}
            </h3>



            <div className="mt-2 text-sm text-[#6B7C78]">
              {item.room && (
                <span>
                  <strong className="text-[#3B6F6A]">Room:</strong>{" "}
                  {item.room}
                </span>
              )}
  ...
  const ComingSoon = ({ day }: { day: number }) => (
    <div className="text-center py-20">
      <h2 className="text-2xl md:text-3xl font-bold mb-3 text-[#2F3E3B]">
        Day {day} Agenda
      </h2>
  ...
  return (
    <section id="agenda-section" className="bg-[#FFFFFF] py-16 px-4">
      <div className="max-w-6xl mx-auto">

        {/* Title */}
        <h1 className="text-3xl md:text-4xl font-extrabold text-center mb-4 text-[#2F3E3B]">
          Conference Agenda
        </h1>

        <p className="text-center text-[#6B7C78] mb-12 max-w-2xl mx-auto">
          Three days of inspiring keynotes, technical sessions, workshops, and
          innovation in Artificial Intelligence, Machine Learning, and Robotics.
        </p>

        {/* Day Tabs */}
        <div className="flex justify-center mb-12">
          <div className="flex gap-2 bg-[#FDFBF7] border border-[#E6DED2] p-1 rounded-full">
            {[1, 2, 3].map((day) => (
              <button
                key={day}
                onClick={() => setActiveDay(day)}
                className={`px-6 py-2 text-sm font-bold rounded-full transition-all
                  ${
                    activeDay === day
                      ? "bg-[#3B6F6A] text-white shadow"
                      : "text-[#2F3E3B] hover:bg-[#EEF4F2]"
                  }`}
              >
                Day {day}
              </button>
        ...
        <p className="text-[#6B7C78] mt-10 max-w-2xl text-center mx-auto">
          The agenda is subject to change. More sessions and speakers will be
          announced soon.
        </p>
