  ...
  return (
    <>
      ...
      <Helmet>
        ...
        <meta
          name="description"
          content="Submit your research abstract for the AI, ML & Robotics Conference (AIMLR 2026) in Rome. Peer-reviewed presentation opportunities for global researchers."
        />
        <meta
          name="keywords"
          content="Call for Abstracts AI, AI ML Robotics Conference, Abstract Submission, Research Conference, AIMLR 2026"
        />
        <link
          rel="canonical"
        ...
        <meta property="og:type" content="website" />
        <meta property="og:title" content="Call for Abstracts - AIMLR 2026" />
        <meta
          property="og:description"
          content="Submit your abstract and present your research at AIMLR 2026 in Rome."
        />
        <meta
          property="og:image"
        ...
        <meta
          ...
          content="Join global researchers at AIMLR 2026. Abstract submissions now open."
        />
        <meta
          name="twitter:image"
          content="https://roboticsaisummit.com/aimllogo.jpg"
        ...
        <div className="max-w-5xl mx-auto px-6 py-12">
          ...
          <div className="mb-12 border-l-2 border-[#0F766E]/40 pl-5">
            ...
            <p className="text-[16.5px] text-slate-600 leading-relaxed max-w-3xl">
              ...
              & Robotics (AIMLR 2026), held in Rome, Italy with hybrid participation.
            </p>
