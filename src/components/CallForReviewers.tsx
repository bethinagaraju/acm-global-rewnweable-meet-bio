  ...
  return (
    <>
      ...
      <Helmet>
        ...
        <meta
          property="og:description"
          content="Apply to become a peer reviewer for the premier AI & Robotics conference."
        />
        <meta
          property="og:image"
          content="https://roboticsaisummit.com/aimllogo.jpg"
        ...
        <section className="px-6 pt-14 pb-10">
          <div className="max-w-6xl mx-auto">
            ...
            <p className="mt-3 max-w-3xl text-[17px] text-[#6B7C78]">
              Join the Scientific Committee and contribute to maintaining the
              academic quality of ICBME 2026.
            </p>
      ...
      background:
        "linear-gradient(90deg, rgb(238, 244, 242) 0%, rgba(238, 244, 242, 0.54) 39%, rgb(238, 244, 242) 100%, rgba(238, 244, 242, 0.55) 65%)",
            ...
            <p className="text-[16.5px] leading-relaxed">
              We invite qualified researchers and academicians to serve as peer
              reviewers for ICBME 2026 and help ensure the technical rigor,
              originality, and relevance of submitted research contributions.
            </p>
          </div>

          {/* SECTIONS */}
          <SectionCard icon={<Users />} title="Who Can Apply?">
            {[
              "Professors & Associate Professors",
              "Postdoctoral Researchers",
              "Experienced Researchers",
          ...
          <SectionCard icon={<Award />} title="Reviewer Benefits">
            {[
              "Official Reviewer Certificate",
              "Recognition on the conference website",
              "Academic networking and professional visibility",
