        ...
        <div className="space-y-10">
          {attendees.map((item, index) => {
            ...
            return (
              <div
                key={index}
                className="flex items-start gap-5 pb-6 border-b border-[#E8E1D6] last:border-none"
              >
                {/* Icon */}
                <div className="mt-1 flex items-center justify-center w-10 h-10 rounded-full bg-[#EEF4F2] border border-[#DCE7E3]">
                  <Icon className="w-5 h-5 text-[#3B6F6A]" />
                </div>
