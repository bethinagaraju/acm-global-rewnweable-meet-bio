...
export default function ScientificSessions() {
  ...
  return (
    <section className="w-full py-20 px-4 bg-white relative overflow-hidden">
      ...
      {/* Decorative Background Blur (neutralized) */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-7xl h-96 bg-gray-100 blur-[120px] rounded-full pointer-events-none -z-10" />

      <div className="max-w-7xl mx-auto relative z-10">

        {/* Header */}
        <div className="text-center mb-16">
          <span className="text-slate-600 font-semibold tracking-wider text-sm uppercase mb-2 block">
            Scientific Program
          </span>
          ...
          <div className="h-1.5 w-24 bg-slate-200 mx-auto rounded-full mb-6"></div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
          ...
          <Link to="/AbstractSubmission">
            <div className="h-full p-1 rounded-xl bg-gray-100 hover:bg-slate-200 transition">
              <button className="w-full h-full bg-white rounded-lg px-6 py-4 flex flex-col items-center gap-2">
          ...
          {/* Register */}
          <Link to="/register">
            <div className="h-full p-1 rounded-xl bg-slate-200 hover:bg-slate-300 transition">
              <button className="w-full h-full bg-white rounded-lg px-6 py-4 flex flex-col items-center gap-2">
                <div className="w-10 h-10 rounded-full bg-slate-100 flex items-center justify-center">
