...
const CallForPostersPage: React.FC = () => {
  ...
  <meta 
    name="description" 
    content="Submit your research poster for ICBME 2026 in Rome, July 28-30. Ideal for early-stage research, student projects, and visual presentations in AI, ML & Robotics." 
  />
  ...
  <meta property="og:description" content="Present your research visually at ICBME 2026 in Rome. We invite posters on Artificial Intelligence, Machine Learning, and Robotics." />
