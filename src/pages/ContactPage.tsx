        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            <InfoRow
              icon={<MapPin />}
              title="Venue"
              value="Crowne Plaza – St. Peter’s, Rome, Italy"
            />
            <InfoRow
              icon={<Clock />}
              title="Conference Dates"
              value="July 28–30, 2026"
            />
            <InfoRow
              icon={<Mail />}
              title="Email"
              value="secretary@roboticsaisummit.com"
              link="mailto:secretary@roboticsaisummit.com"
            />
            <InfoRow
              icon={<Phone />}
              title="Phone"
              value="+1 (443) 653-0066"
              link="tel:+14436530066"
            />
            <InfoRow
              icon={<Clock />}
              title="Office Hours"
          ...
          {/* Right: Form */}
          <div className="bg-white border border-[#E6DED2] rounded-md p-6">
            <h2 className="text-lg font-semibold text-[#2F3E3B] mb-4">
              Send a Message
            </h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <input
                ...
                required
                className="w-full border border-[#E6DED2] px-4 py-2 rounded text-sm"
              />
              ...
              <textarea
                ...
                onChange={handleChange}
                required
                className="w-full border border-[#E6DED2] px-4 py-2 rounded text-sm resize-none"
              />

              <button
                type="submit"
                className="inline-flex items-center gap-2 bg-[#3B6F6A] text-white px-6 py-2 rounded text-sm font-semibold hover:bg-[#335F5B] transition"
              >
  ...
  <div className="flex gap-3 items-start">
    ...
    <div>
      ...
      {link ? (
        ...
        <p className="text-sm text-[#5F6F6C]">{value}</p>
      )}
    </div>
  </div>
);
