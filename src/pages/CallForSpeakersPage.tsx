...
const CallForSpeakersPage: React.FC = () => {
  ...
  <title>Call for Speakers | ICBME 2026 AI, ML & Robotics Conference</title>

  {/* ✅ 2. DESCRIPTION: Targeted at experts/professors */}
  <meta 
    name="description" 
    content="Apply to speak at ICBME 2026. We invite keynote speakers, industry leaders, and researchers in AI, ML & Robotics to present in Rome, July 2026." 
  />
