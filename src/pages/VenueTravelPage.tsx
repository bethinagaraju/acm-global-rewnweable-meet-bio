    ...
    <div className="bg-[#FFFFFF]">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="bg-[#FFFFFF] border border-[#E6DED2] rounded-xl p-7 shadow-sm">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <h3 className="text-xl font-bold text-[#2F3E3B]">
                    Nearest Airport
                  </h3>
                </div>
                ...
                <p className="mt-5 text-xs text-[#6B7C78] border-t border-[#E8E1D6] pt-4">
                  Travel time and fares may vary.
                </p>
              </div>
      ...
      background:
        "linear-gradient(90deg, rgb(238, 244, 242) 0%, rgba(238, 244, 242, 0.54) 39%, rgb(238, 244, 242) 100%, rgba(238, 244, 242, 0.55) 65%)",
                ...
                <ul className="space-y-3">
                  <TransportOption label="Metro / Bus Ticket" />
            ...
            {/* ================= VISA SUPPORT ================= */}
            <div className="bg-[#EEF4F2] border border-[#DCE7E3] rounded-xl p-8">
              <h2 className="text-2xl font-bold text-center text-[#2F3E3B] mb-10">
                Visa & Conference Support
              </h2>

              <div className="grid md:grid-cols-2 gap-8">
                <div className="bg-[#FDFBF7] border border-[#E6DED2] rounded-lg p-6">
                  <h3 className="font-semibold text-[#3B6F6A] mb-4">
                    Visa Requirements
                  </h3>
                ...
                <div className="bg-[#FDFBF7] border border-[#E6DED2] rounded-lg p-6">
                  ...
                  <ul className="space-y-3 text-sm text-[#000000] ">
                    ...
                    <li className="flex gap-2 flex items-center">
                      <Phone className="w-4 h-4 text-[#3B6F6A]" />
                      Support hotline for visa assistance
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="flex justify-center mt-10">
                <button className="bg-[#3B6F6A] hover:bg-[#335F5B] text-white font-bold px-8 py-3 rounded-md transition">
                  Request Invitation Letter
                </button>
              </div>
            </div>
            ...
            <div>
              <div className="flex items-center gap-4 mb-6">
                <Hotel className="w-8 h-8 text-[#3B6F6A]" />
                <h3 className="text-3xl font-bold text-[#2F3E3B]">
                  Hotel Suggestions
                </h3>
              </div>
            ...
            <div>
              <div className="flex items-center gap-4 mb-6">
                <Camera className="w-8 h-8 text-[#3B6F6A]" />
                <h3 className="text-3xl font-bold text-[#2F3E3B]">
                  Explore Rome
                </h3>
              </div>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <AttractionCard
                  name="Spanish Steps"
                  location="3.5 km from Venue"
                  image="https://images.unsplash.com/photo-1529154036614-a60975f5c760"
                />
              </div>
            </div>
    ...
    <div className="bg-[#FDFBF7] border border-[#E6DED2] rounded-xl overflow-hidden hover:shadow-xl transition">
      ...
      <div className="p-5 space-y-3">
        ...
        <p className="text-sm text-[#6B7C78] flex items-center gap-2">
          <MapPin className="w-4 h-4 text-[#3B6F6A]" />
          {distance}
        </p>
        <button className="w-full mt-2 py-2 rounded-md border border-[#3B6F6A] text-[#3B6F6A] hover:bg-[#3B6F6A] hover:text-white transition">
          View Details
        </button>
      </div>
    </div>
